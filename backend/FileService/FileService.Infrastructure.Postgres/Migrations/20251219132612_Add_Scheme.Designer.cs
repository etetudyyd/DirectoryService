...
namespace DirectoryService.Migrations
{
    ...
    [Migration("20251219132612_Add_Scheme")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DirectoryService.Assets.MediaAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DirectoryService.Assets.PreviewAsset", b =>
                {
                    b.HasBaseType("DirectoryService.Assets.MediaAsset");
            ...
            modelBuilder.Entity("DirectoryService.Assets.VideoAsset", b =>
                {
                    b.HasBaseType("DirectoryService.Assets.MediaAsset");
            ...
            modelBuilder.Entity("DirectoryService.Assets.MediaAsset", b =>
                {
                    b.OwnsOne("DirectoryService.MediaData", "MediaData", b1 =>
                        {
                            ...
                            b1.OwnsOne("DirectoryService.ContentType", "ContentType", b2 =>
                                {
                            ...
                            b1.OwnsOne("DirectoryService.FileName", "FileName", b2 =>
                                {
                                    b2.Property<Guid>("MediaDataMediaAssetId")
                                        .HasColumnType("uuid");
                    ...
                    b.OwnsOne("DirectoryService.MediaOwner", "Owner", b1 =>
                        {
                            b1.Property<Guid>("MediaAssetId")
                                .HasColumnType("uuid");
